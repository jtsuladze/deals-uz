          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div>
              <label style={{ 
                ...
                📸 {type === 'item' ? 'Product Photo' : 'Service Photo'} (Optional)
              </label>
              ...
              <div style={{ marginTop: '1rem' }}>
                ...
                <input
                  ...
                  style={{ 
                    ...
                    borderRadius: '8px',
                    fontSize: '0.9rem',
                    backgroundColor: imageFile ? '#f8f9fa' : 'white',
                    color: imageFile ? '#999' : '#333',
                    transition: 'border-color 0.3s ease',
                    outline: 'none'
                  }}
                  onFocus={(e) => !imageFile && (e.target.style.borderColor = '#007bff')}
                  onBlur={(e) => e.target.style.borderColor = '#e9ecef'}
                />
              </div>
            </div>
